...
<Image src={copilotHeaderButton} alt="A screenshot of the dashboard with the GitHub Copilot button highlighted." />
...
<Image src={copilotChatQuestion} alt="A screenshot of the dashboard with GitHub Copilot open. It contains a chat question and answer." />
...
<Image src={resourcesAskCopilot} alt="A screenshot of the Ask GitHub Copilot option in the resource context menu page." />
...
<Image src={structuredLogsExplainError} alt="A screenshot of the structured logs page with an Explain errors button." />
...
<Image src={traceDetailsExplainTrace} alt="A screenshot of the trace details page with an Explain trace button." />
