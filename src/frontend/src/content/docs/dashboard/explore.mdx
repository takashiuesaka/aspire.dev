...
import dotnetRunLoginUrl from '@assets/dashboard/explore/dotnet-run-login-url.png';
import aspireLogin from '@assets/dashboard/explore/aspire-login.png';
import aspireLoginHelp from '@assets/dashboard/explore/aspire-login-help.png';
import aspireLoginFilled from '@assets/dashboard/explore/aspire-login-filled.png';
import projects from '@assets/dashboard/explore/projects.png';
import projectGraphs from '@assets/dashboard/explore/project-graphs.png';
import resourceStopAction from '@assets/dashboard/explore/resource-stop-action.png';
import resourceStoppedAction from '@assets/dashboard/explore/resource-stopped-action.png';
import resourceStartedAction from '@assets/dashboard/explore/resource-started-action.png';
import resourceActions from '@assets/dashboard/explore/resource-actions.png';
import resourceSubmenuActions from '@assets/dashboard/explore/resource-submenu-actions.png';
import textVisualizerSelectionMenu from '@assets/dashboard/explore/text-visualizer-selection-menu.png';
import textVisualizerResources from '@assets/dashboard/explore/text-visualizer-resources.png';
import resourceDetails from '@assets/dashboard/explore/resource-details.png';
import selectResourceType from '@assets/dashboard/explore/select-resource-type.png';
import resourcesFilteredContainers from '@assets/dashboard/explore/resources-filtered-containers.png';
import projectsErrors from '@assets/dashboard/explore/projects-errors.png';
import structuredLogsErrors from '@assets/dashboard/explore/structured-logs-errors.png';
import structuredLogsErrorsView from '@assets/dashboard/explore/structured-logs-errors-view.png';
import projectLogs from '@assets/dashboard/explore/project-logs.png';
import projectLogsError from '@assets/dashboard/explore/project-logs-error.png';
import containerLogs from '@assets/dashboard/explore/container-logs.png';
import downloadConsoleLogs from '@assets/dashboard/explore/download-console-logs.png';
import consoleLogsWithReplicas from '@assets/dashboard/explore/console-logs-with-replicas.png';
import structuredLogs from '@assets/dashboard/explore/structured-logs.png';
import structuredLogsFiltered from '@assets/dashboard/explore/structured-logs-filtered.png';
import traces from '@assets/dashboard/explore/traces.png';
import traceViewFilter from '@assets/dashboard/explore/trace-view-filter.png';
import tracesFiltering from '@assets/dashboard/explore/traces-filtering.png';
import telemetryResourceFilter from '@assets/dashboard/explore/telemetry-resource-filter.png';
import structuredLogsTraceErrors from '@assets/dashboard/explore/structured-logs-trace-errors.png';
import trace from '@assets/dashboard/explore/trace.png';
import traceSpanDetails from '@assets/dashboard/explore/trace-span-details.png';
import traceSpanEventDetails from '@assets/dashboard/explore/trace-span-event-details.png';
import filterSpansTraceDetails from '@assets/dashboard/explore/filter-spans-trace-details.png';
import tracesErrors from '@assets/dashboard/explore/traces-errors.png';
import traceViewErrors from '@assets/dashboard/explore/trace-view-errors.png';
import metricsView from '@assets/dashboard/explore/metrics-view.png';
import metricsTableView from '@assets/dashboard/explore/metrics-table-view.png';
import metricsViewFiltered from '@assets/dashboard/explore/metrics-view-filtered.png';
import metricsViewCount from '@assets/dashboard/explore/metrics-view-count.png';
import dashboardGeniVisualizer from '@assets/dashboard/explore/dashboard-geni-visualizer.gif';
import metricsPageExemplars from '@assets/dashboard/explore/metrics-page-exemplars.png';
...
```bash title="Example output of aspire run" {10}
aspire run
...
<Image src={aspireLoginHelp} alt="Aspire dashboard login page with instructions on how to obtain the token." />

After copying the token from the console and pasting it into the login page, select the **Log in** button.

<Image src={aspireLoginFilled} alt="Aspire dashboard login page with the token pasted into the textbox." />
...
The **Resources** page is the default home page of the Aspire dashboard. This page lists all of the .NET projects, containers, and executables included in your Aspire solution. For example, the starter application includes two projects:
...
<Image src={projects} alt="A screenshot of the Aspire dashboard Resources page." />
...
<Image src={resourceStopAction} alt="Aspire dashboard stop resource." />
...
<Image src={resourceStoppedAction} alt="Aspire dashboard resource stopped." />
...
<Image src={resourceStartedAction} alt="Aspire dashboard started resource." />
...
<Image src={resourceSubmenuActions} alt="Aspire dashboard disabled submenu actions." />
...
<Image src={textVisualizerSelectionMenu} alt="A screenshot of the Aspire dashboard Resources page, showing the ellipsis menu options." />
...
<Image src={textVisualizerResources} alt="A screenshot of the Aspire dashboard Resources page, showing the text visualizer." />
...
<Image src={resourceDetails} alt="A screenshot of the Aspire dashboard Resources page with the details of a selected resource displayed." />
...
<Image src={selectResourceType} alt="A screenshot of the resource type selector list in the Aspire dashboard Resources page." />
...
<Image src={resourcesFilteredContainers} alt="A screenshot of the Aspire dashboard Resources page filtered to show only containers." />
...
<Image src={projectsErrors} alt="A screenshot of the Aspire dashboard Resources page, showing a project with errors." />
...
<Image src={structuredLogsErrors} alt="A screenshot of the Aspire dashboard Structured logs page, showing a filter applied to show only the logs relevant to the resource." />
...
<Image src={structuredLogsErrorsView} alt="A screenshot of the Aspire dashboard Structured logs page, showing a lower window with the structured log entry details." />
...
<Image src={projectLogs} alt="A screenshot of the Aspire dashboard Console Logs page with a source selected." />
...
<Image src={projectLogsError} alt="A screenshot of the Aspire dashboard Console Logs page, showing logs with errors." />
...
<Image src={containerLogs} alt="A screenshot of the Aspire dashboard Console logs page with a container source selected." />

You can download any console log to your local machine and use your preferred text programs to analyze it:

<Image src={downloadConsoleLogs} alt="A screenshot of the Aspire dashboard Console logs page showing how to download a log to your local machine." />
...
<Image src={consoleLogsWithReplicas} alt="Aspire dashboard: Console logs page resource selector with nested replica resources." />
...
<Image src={structuredLogs} alt="A screenshot of the Aspire dashboard Semantic logs page." />
...
<Image src={structuredLogsFiltered} alt="A screenshot of the Aspire dashboard Structured logs page showing the filter dialog." />
...
<Image src={traces} alt="A screenshot of the Aspire dashboard Traces page." />
...
<Image src={traceViewFilter} alt="A screenshot of the Aspire dashboard Traces page, showing a filter applied to show only traces with the term 'weather'." />
...
<Image src={tracesFiltering} alt="A screenshot of the Aspire dashboard Traces page, showing the Add filter dialog with the http.route parameter selected." />
...
<Image src={telemetryResourceFilter} alt="Filter by all instances of a resource" />
...
<Image src={structuredLogsTraceErrors} alt="A screenshot of the Aspire dashboard Structured logs page, showing a filter applied to show only the logs relevant to the trace." />
...
<Image src={trace} alt="A screenshot of the Aspire dashboard Trace details page." />

For each span in the trace, select **View details** to see more details:

<Image src={traceSpanDetails} alt="A screenshot of the Aspire dashboard Trace details page with the details of a span displayed." />
...
<Image src={traceSpanEventDetails} alt="A screenshot of the Aspire dashboard Trace details page with the event timings for a span displayed." />

For complex traces with many spans, use the **Filter** textbox to display only matching spans:

<Image src={filterSpansTraceDetails} alt="A screenshot of the Aspire dashboard Trace details page with the filter used to display only weather spans." />
...
<Image src={tracesErrors} alt="A screenshot of the Aspire dashboard Traces page, showing traces with errors." />

And the corresponding detailed view of the trace with errors:

<Image src={traceViewErrors} alt="A screenshot of the Aspire dashboard Trace details page, showing a trace with errors." />
...
<Image src={metricsView} alt="A screenshot of the Aspire dashboard Metrics page." />
...
<Image src={metricsTableView} alt="A screenshot of the Aspire dashboard Metrics page with the table view selected." />
...
<Image src={metricsViewFiltered} alt="A screenshot of the Aspire dashboard Metrics page with a filter applied to the chart." />

You can also choose to select the count of the displayed metric on the vertical access, instead of its values:

<Image src={metricsViewCount} alt="A screenshot of the Aspire dashboard Metrics page with the count option applied." />
...
<LoopingImage src={dashboardGeniVisualizer} alt="An animated screenshot of the Aspire dashboard GenAI telemetry visualizer in action." />
...
The Aspire dashboard supports and displays OpenTelemetry _Exemplars_. An _exemplar_ links a metric data point to the operation that recorded it, serving as a bridge between metrics and traces.
...
<Image src={metricsPageExemplars} alt="Aspire Dashboard: Metrics Page, with exemplar indicator hover details." />
...
- Operation performed, in this case an:
  ...
  ```http title="HTTP — images collection request"
...
<Image src={tracePageFromExemplars} alt="Aspire Dashboard: Trace Page, navigated to from the corresponding Metrics Page exemplar." />
...
<Image src={pauseTelemetry} alt="A screenshot of the Aspire dashboard Console logs page, showing how to pause telemetry." />
...
<Image src={themeSelection} alt="The Aspire dashboard Settings dialog, showing the System theme default selection." />

If you prefer the Light theme, you can select it from the theme selection dialog:

<Image src={themeSelectionLight} alt="The Aspire dashboard Settings dialog, showing the Light theme selection." />

## Dashboard shortcuts

The Aspire dashboard provides various shortcuts to _help_ you navigate and control different parts of the dashboard. To display the keyboard shortcuts, press <Kbd windows="Shift+?" mac="Shift+?" linux="Shift+?" />, or select the question mark icon in the top-right corner of the dashboard:

<Image src={dashboardHelp} alt="Aspire dashboard Help modal dialog." />

The following shortcuts are available:

**Panels**:

- <Kbd windows="+" mac="+" linux="+" />: Increase panel size.
- <Kbd windows="-" mac="-" linux="-" />: Decrease panel size.
- <Kbd windows="Shift+R" mac="Shift+R" linux="Shift+R" />: <u>R</u>eset panel size.
- <Kbd windows="Shift+T" mac="Shift+T" linux="Shift+T" />: <u>T</u>oggle panel orientation.
- <Kbd windows="Shift+X" mac="Shift+X" linux="Shift+X" />: Close panel.

**Page navigation**:

- <Kbd windows="R" mac="R" linux="R" />: Go to **<u>R</u>esources**.
- <Kbd windows="C" mac="C" linux="C" />: Go to **<u>C</u>onsole Logs**.
- <Kbd windows="S" mac="S" linux="S" />: Go to **<u>S</u>tructured Logs**.
- <Kbd windows="T" mac="T" linux="T" />: Go to **<u>T</u>races**.
- <Kbd windows="M" mac="M" linux="M" />: Go to **<u>M</u>etrics**.

**Site-wide navigation**:

- <Kbd windows="?" mac="?" linux="?" />: Got to **Help**.
- <Kbd windows="Shift+S" mac="Shift+S" linux="Shift+S" />: Go to **<u>S</u>ettings**.
