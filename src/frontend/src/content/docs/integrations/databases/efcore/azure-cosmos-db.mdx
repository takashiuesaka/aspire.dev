---
title: Azure Cosmos DB Entity Framework Core integration
description: Learn how to use the Aspire Azure Cosmos DB Entity Framework Core integration to connect your Aspire applications to Azure Cosmos DB databases.
---
...
```csharp csharp title="C# — AppHost.cs"
...
```csharp csharp title="C# — Program.cs"
