...
// Note: Loaders must be inline functions (not imported) due to astro-mermaid serialization
// See: https://github.com/joesaby/astro-mermaid/blob/main/astro-mermaid-integration.js#L135-L158
...
export const iconPacks = [
  ...
  {
    // Custom Aspire icons - inlined to work around astro-mermaid serialization bug
    name: 'aspire',
    loader: () =>
      Promise.resolve({
        prefix: 'aspire',
